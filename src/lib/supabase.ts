...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  id: 'default',
  site_name: 'Nível Taquari',
  site_subtitle: 'Nível Rio Taquari - Monitoramento do Rio em Tempo Real',
  site_description: 'Acompanhe o Nível Taquari e o Nível Rio Taquari em tempo real. Plataforma de monitoramento dos rios da Bacia Taquari-Antas, com dados ambientais, meteorologia, alertas e informações do Vale do Taquari.',
  logo_url: null,
  favicon_url: null,
  ...
  if (isSupabaseConfigured && supabase) {
    try {
      ...
      if (!error && data) {
        ...
        if (typeof window !== 'undefined') {
          // Supabase is the source of truth; only cache it for offline fallback.
